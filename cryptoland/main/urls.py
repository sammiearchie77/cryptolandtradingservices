...
urlpatterns = [
    ...
    path('withdraw/confirm/', views.confirm_withdrawal, name='confirm-withdrawal'),
    path('withdraw/verification-documents/', views.withdraw_verification, name='withdraw-verification'),
